...
> Configuration that fails at startup instead of at 3am.

Typed configuration: environment schemas with validation, layered sources, secrets, feature flags and per-tenant configuration.
...
- [API reference](../../../docs/security-platform/api.md#munaxaconfig)
