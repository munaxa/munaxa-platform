...
> Delivery without the product knowing which transport ran.

Channel-agnostic notification delivery: email, SMS, push and in-app, with templates, providers, retries and a secret-leak guard.
...
// package.json
"dependencies": {
  "@munaxa/notifications": "workspace:^"
}
```
...
- [API reference](../../../docs/security-platform/api.md#munaxanotifications)
